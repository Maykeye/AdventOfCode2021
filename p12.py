...
def visit(edges, current_node, path_so_far, all_paths):
    if current_node == "end": 
    ...
    for next_node in edges[current_node]:
        if next_node in path_so_far and next_node.islower():
            continue
        visit(edges, next_node, path_so_far+[next_node], all_paths)
